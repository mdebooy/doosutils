...
public class PersistenceExceptionHandler {
  private IProfiler profiledClass;
...
//      throw new IllegalArgumentException("Vanwege de aanroep van "
//          + PersistenceExceptionHandler.class.getName()
//          + ", moet jouw class de "
//          + IProfiler.class.getCanonicalName() + " interface implementeren",
...
//          + " kan het gevraagde object met de parameters "
//          + convertParameters(invocation.getParameters()) + " niet vinden.",
//          this.profiledClass.getApplicationName());
//    }
//
